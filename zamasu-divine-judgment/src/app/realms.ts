...
/** Fase já entregue: reinos abertos pertencem a ela ou a anteriores. */
...
export const REALMS: Realm[] = [
  ...
  { id: 'tribunal', path: '/tribunal', label: 'Tribunal Divino', glyph: '⚖', status: 'open', phase: 2, summary: 'Dilemas de justiça. Zamasu julga as suas respostas.' },
  { id: 'arena', path: '/arena', label: 'Arena Divina', glyph: '⚔', status: 'sealed', phase: 3, summary: 'Batalhas estratégicas contra a divindade.' },
  { id: 'timelines', path: '/linhas-temporais', label: 'Arquivo das Linhas Temporais', glyph: '⌬', status: 'sealed', phase: 4, summary: 'A história — e as histórias que poderiam ter sido.' },
